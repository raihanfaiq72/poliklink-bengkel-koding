...
<head>
    ...
    <script data-cfasync="false" nonce="57dc7917-79b7-442c-af34-f88dbc1a07ec">
        try {
            (function (w, d) {
                ! function (j, k, l, m) {
                    if (j.zaraz) console.error("zaraz is loaded twice");
                        ...
                        j.zaraz._v = "5838";
                        j.zaraz._n = "57dc7917-79b7-442c-af34-f88dbc1a07ec";
                        j.zaraz.q = [];
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="https://adminlte.io/themes/v3/dist/img/user1-128x128.jpg"
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="https://adminlte.io/themes/v3/dist/img/user3-128x128.jpg"
                                                alt="message user image">
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
