                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content">
                                                    <a href="{{ url('admin/obat/' . $polri->id) }}" class="btn btn-primary">Edit</a>
                                                    <form action="{{ url('admin/obat/' . $polri->id) }}/delete" method="POST" style="margin-left: 10px;">
                                                        @csrf
                                                        <button class="btn btn-danger" onclick="confirmDelete('{{ url('admin/obat/' . $polri->id) }}/delete')">Hapus</button>                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
                                        @empty
